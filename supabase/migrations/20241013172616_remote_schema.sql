...
CREATE POLICY "Enable delete for users based on user_id" ON "public"."todos" FOR DELETE TO "authenticated" USING (true);
...
CREATE POLICY "Enable update for users based on email" ON "public"."todos" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
